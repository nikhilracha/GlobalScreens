...
class GData extends Component {
  ...
  selectPhoto(event, obj) {
    ...
    this.props.sendData(photos[obj.index].selected);
    this.simgs();
  }
  ...
  //     console.log(
  //       "prevstate of component and present state",
  //       prevState.photos,
  //       this.state.photos
  //     );
  //     console.log("component updating", this.state.photos);
  //     this.refresh();
  //   }
  // }
